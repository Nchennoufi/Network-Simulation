 ...
 */
    size_t set_values(const std::vector<double>& toset);
/*! Number of nodes */
    size_t size() const;
...
/*! Check if a link already exists */
    bool link_existant(const size_t& a,const size_t& b);
/*! Check if it is possible to add a link in the multimap */
	bool link_possible(const size_t& a,const size_t& b);
